...
function Inspector({
  ...
  return /* @__PURE__ */ jsx("section", { className: "inspector", "aria-label": "Story inspector", children: /* @__PURE__ */ jsxs(Tabs.Root, { value: tab, onValueChange: onTabChange, className: "inspector-tabs", children: [
